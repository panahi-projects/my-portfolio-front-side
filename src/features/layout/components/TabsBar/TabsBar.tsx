...
export function TabsBar() {
  ...
  return (
    <div className="flex shrink-0 flex-col text-xs select-none">
      {/* Tab strip */}
      <div
      ...
      {/* Breadcrumb row, on a separate strip beneath the tabs (matches screenshots). */}
      {openTabs.length > 0 ? (
        <div
          className="flex h-6 items-center gap-1 px-4 text-[11px] opacity-70"
          style={{
